...
<div class="container">
    <div class="row mt-5 mb-2">
        <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-3 col-1">
            <div class="row">
                <div class="fs-3 col-xxl-8 col-xl-9 col-lg-7 col-md-9 col-sm-8 col-8">
                    <a href="dashboards.php" style="text-decoration: none" class="fs-3 text-secondary">Dashboards</a>
                </div>
        ...
        <div class="col-xxl-2 col-xl-2 col-lg-3 col-md-3 col-sm-3 col-8">
            <p class="fs-3 text-dark">Projetos</p>
        </div>
    </div>
            ...
            <div class="card">
                <div class="card-body p-1">
                    <div class="row d-flex justify-content-center">
                        <div class="p-1 text-dark col-xxl-8 col-xl-7 col-lg-8 col-md-8 col-sm-8">Todos os projetos</div>
                        <div class="p-1 col-xxl-3 col-xl-3 col-lg-3 col-md-3 col-sm-3">
